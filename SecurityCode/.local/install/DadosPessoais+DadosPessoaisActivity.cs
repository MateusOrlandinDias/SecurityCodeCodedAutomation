...
{
    public class DadosPessoaisActivity : System.Activities.Activity
    {
    ...
    internal class DadosPessoaisActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public OutArgument<string> out_strTextoSha1 { get; set; }
        ...
        {
            var codedWorkflow = new global::SecurityCode.DadosPessoais();
            ...
            var result = await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "DadosPessoais.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "DadosPessoais.cs", Exception = exception});
                }
