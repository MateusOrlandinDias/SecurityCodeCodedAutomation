...
{
    public class GeraCodigoSegurancaPreviewActivity : Activity
    {
        ...
        public GeraCodigoSegurancaPreviewActivity()
        {
            this.Implementation = () =>
            {
                return new GeraCodigoSegurancaPreviewActivityChild()
    ...
    internal class GeraCodigoSegurancaPreviewActivityChild : CodeActivity
    {
        public InArgument<string> in_inputHash { get; set; }
        ...
        public GeraCodigoSegurancaPreviewActivityChild()
        {
            DisplayName = "GeraCodigoSegurancaPreview";
        }

        protected override void Execute(CodeActivityContext context)
        {
            var codedWorkflow = new CodigoSeguranca.GeraCodigoSegurancaPreview();
            ...
            var result = CodedWorkflowHelper.RunWithExceptionHandling(() =>
            {
                ...
                {RelativeFilePath = "CodigoSeguranca\\GeraCodigoSegurancaPreview.cs"});
            }, () =>
            {
            ...
            }, (exception, outArgs) =>
            {
                ...
                {RelativeFilePath = "CodigoSeguranca\\GeraCodigoSegurancaPreview.cs", Exception = exception});
            });
